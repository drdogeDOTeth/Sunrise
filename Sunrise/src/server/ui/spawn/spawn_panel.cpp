 ...
 * #58 spelled this as the raw 12; #66 gave the space names, and `Biped` is that same value.
 */
constexpr ObjectType kCombatantType = ObjectType::Biped;
...
/**
 * @return True when a package family holds nothing a population can use.
 * Restored from #58 in the #66 merge: #66 rewrote this region and the clean auto-merge kept the
 * call in `collect_roster` while taking #66's deletion of the definition.
 */
